(() => {
    ...
    (() => {
        ...
        function currentActivePage() {
            ...
            const menuLinks = headerMenu.querySelectorAll("[data-page]");
            if (currentPage && menuLinks) menuLinks.forEach((menuLink => {
                const linkValue = menuLink.getAttribute("data-page");
                if (linkValue === currentPage) menuLink.classList.add("active-page");
            }));
        }
        currentActivePage();
        window["FLS"] = true;
